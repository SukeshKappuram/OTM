...
insert into DomainLogs(LogHeader,LogCode,LogType,Message,LoggedFor,Status) values ('Table-Deletion:UserRoles','DTR','INFO','Deletion of USERROLES Table successfull','UserRoles',true);
